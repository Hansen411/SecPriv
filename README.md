...
The CipherClient includes an if-else statement to avoid overwriting existing keys, causing the server to disconnect. Additionally, instead of using the 'throws Exception', a try-catch was implemented; otherwise, the connection would sever. 
